...
//Mat4 Mat3Multiply(Mat3 m1, Mat3 m2)
...
Mat3 Mat3Translate(float translate_x, float translate_y){
  return (Mat3 {1.0f, 0.0f, translate_x,
...
int main(int argc, char** argv) {
  ...
  zoro::Vec2 v = { 2.0f, 1.0f };
  /*
    m1 = 1.0f 0.0f
         2.0f 1.0f
  */
  zoro::Mat2 m1 = { 1.0f, 2.0f, 0.0f, 1.0f };
  /*
    m2 = 2.0f 3.0f
         0.0f 2.0f
  */
  zoro::Mat2 m2 = { 2.0f, 0.0f, 3.0f, 2.0f };
  /*
    v1 = m1 * v
     1.0f 0.0f  *  2.0f
     2.0f 1.0f     1.0f
  */
  ...
  printf("Vec2 v1 = m1 * v\n");
  zoro::Vec2 v1 = zoro::Vec2MultMat2Vec2(m1, v);
  /*
    v2 = m2 * v
     2.0f 3.0f  *  2.0f
     0.0f 2.0f     1.0f
  */
  printf("Vec2 v2 = m2 * v\n");
  zoro::Vec2 v2 = zoro::Vec2MultMat2Vec2(m2, v);
  ...
  printf("Mat2 m2 r0 c1 = 5\n");
  zoro::SetValMat2(&m2, 0, 1, 5);
  zoro::PrintMat2(m2);
  printf("Mat2 m2T:\n");
  zoro::PrintMat2(zoro::TransposeMat2(m2));


  printf("Vec2 v1:\n");
  zoro::PrintVec2(v1);

  printf("Vec2 Normalized v1:\n");
  zoro::PrintVec2(zoro::NormalizeVec2(v1));
  printf("Magn:%f\n",zoro::MagnitudeVec2(v1));
  if (zoro::IsNormalizedVec2(v1)) printf("True normalized\n");
  zoro::Vec2 prueba = {2.0f, 5.0f};
  prueba = zoro::NormalizeVec2(prueba);
  zoro::PrintVec2(prueba);
  if (zoro::IsNormalizedVec2(prueba)) printf("True normalized\n");
  printf("Dot:%f\n",zoro::DotVec2(zoro::NormalizeVec2({-5,-5}), zoro::NormalizeVec2({5,5})));

  zoro::Mat3 m3d = zoro::MatIdentity3();
  zoro::Mat3 m23d = zoro::MatIdentity3();
  zoro::PrintMat3(m3d);
  printf("%f\n", zoro::GetValMat3(m3d, 1,1));
  
  zoro::PrintMat3(zoro::SumMat3(m3d, m23d));
