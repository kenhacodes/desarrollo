...
int esat::main(int argc, char **argv)
{
         ...
         esat::WindowIsOpened())
  {
    ...
    for (int i = 0; i < 12; i++)
    {
      ...
      m = esat::Mat4Multiply(esat::Mat4Translate(0, 0, -2.5), m);
      m = esat::Mat4Multiply(esat::Mat4Translate(25.0f, 3, 0), m);
      
      m = esat::Mat4Multiply(esat::Mat4Scale(0.5,2,0.5), m);
    
      m = esat::Mat4Multiply(esat::Mat4RotateY((6.28f / 12) * i), m);
      
      m = esat::Mat4Multiply(esat::Mat4Translate(0.0f, 0.0f, 16.5f), m);
    ...
    for (int i = 0; i < 12; i++)
    {
      ...
      m = esat::Mat4Multiply(esat::Mat4Translate(10.0f, 0, 0), m);
      
      m = esat::Mat4Multiply(esat::Mat4Scale(4,0.8,1), m);
